...
(function($) {
	...
	$items.on('click', function() {
		var prev = $('.nav-sidebar > li.nav-expanded'), next = $(this);
...
function loadJS(e, t) {
	for (i = 0; i < e.length; i++) {
		var n = document.getElementsByTagName('body')[0], r = document
...
function loadCSS(e, t) {
	if (!cssArray[e]) {
		cssArray[e] = !0;
		var n = document.getElementsByTagName('head')[0], r = document
				.createElement('link');
	...
	$
			.ajax({
				...
				error : function(e, n, r) {
					t
							.html('<h4 style="margin-top:90px;"><i class="fa fa-warning"></i> Error 404! Page not found.</h4>')
				},
				async : !1
			})
}
function dropSidebarShadow() {
	...
	e < 60 ? $('.sidebar-header').addClass('drop-shadow')
...
function browser() {
	...
	var e = !!window.opera && !!window.opera.version, t = i('MozBoxSizing'), n = Object.prototype.toString
			.call(window.HTMLElement).indexOf('Constructor') > 0, r = !n
			&& i('WebkitTransform');
	return e ? !1 : n || r ? !0 : !1
}
function retina() {
...
function todoList() {
	...
	$('.todo-list-tasks > li > label > .custom-checkbox').change(
			function() {
				$(this).parent().parent().clone().appendTo('.completed')
						.addClass('disabled').find('.custom-checkbox').attr(
								'disabled', !0);
...
function widthFunctions() {
	var t = $('.navbar, .page-header').outerHeight(), r = $(window).height(), i = $(
			window).width();
	$('.sidebar-menu').css('height', r);
	$('.nav-sidebar').css('height', r+150);
	i < 992 && $('body').removeClass('sidebar-minified');
	i > 768 && $('.main').css('min-height', r);
}
$.ajaxLoad = !1;
var cssArray = {};
if ($.ajaxLoad) {
		...
		.ready(
				function(e) {
							...
							.click(
									function(t) {
										...
										if (e(this).parent().find('ul').size() != 0) {
											e(this).parent().hasClass('opened') ? e(
					...
					e('#main-menu-toggle').click(function() {
						var hide = e('body').hasClass('sidebar-hide');
						if (hide == true) {
							e('body').removeClass('sidebar-hide');
							$("#page").removeClass('mainFull');
							$("#page").addClass('main')
						} else {
							e('body').addClass('sidebar-hide');
							$("#page").removeClass('main');
							$("#page").addClass('mainFull')
						}
					});
					...
					e('.btn-settings').click(function(t) {
						t.preventDefault();
						e('#myModals').modal('show');
					})
					e('.btn-settingss').click(function(t) {
						t.preventDefault();
						e('#myModalss').modal('show');
					})
