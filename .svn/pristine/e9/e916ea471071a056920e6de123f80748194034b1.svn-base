 ...
 * @author yp
 */
public class PaperSignatureContent extends BaseExperience
{
	 ...
	 * 书签
	 */
	public final String MARKER = "table_qznr";
	 ...
	 * 生产部门签名
	 */
	final String PD_OPINION_PERSON = "mtext_qznrt_pd_opinion_person";
	 ...
	 * 主管部门签名
	 */
	final String AD_OPINION_PERSON = "mtext_qznrt_ad_opinion_person";
	...
	public void setPD_OPINION_PERSON(String pd_opinion_person){
		this.map.put(this.PD_OPINION_PERSON, pd_opinion_person);
	}
	...
	public void setAD_OPINION_PERSON(String ad_opinion_person){
		this.map.put(this.AD_OPINION_PERSON, ad_opinion_person);
	}
	
	public Map<String,Object> getSignatureContentMap(){
		return this.map;
	}
}
