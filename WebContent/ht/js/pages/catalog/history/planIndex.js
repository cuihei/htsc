...
var detail = {
	...
	createUserColumns : function(){
		...
		grid.addColumn("100px","measurementPeriod","基测");
		grid.addColumn("100px","testIng","检测");
		...
		grid.addColumn("100px","publicationDate","出版日期");
		grid.addColumn("80px","printNum","印次");
	...
	requestUserData : function(){
		common.init("../hcd/list?type=1","POST",detail.bindUserGrid);
		common.do_submit();
	},
	...
	bindPageEvent : function(){
		...
		$("#btn").click(function(){
			common.toPage("../hcd/export?type=1");
		});
	}
}