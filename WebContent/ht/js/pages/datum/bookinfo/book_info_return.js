$(function(){
	book_info_borrowing.init();
})

var book_info_borrowing = {
	/**
	 * 初始化
	 */
	init : function(){
		book_info_borrowing.bindPageEvent();
	},
	...
	bindPageEvent : function(){
		...
		$("#submit").on("click",function(){
			...
			common.init("../bookinfo/return_book?bookNo="+bookNo+"&returnNo="+returnNo,"POST",function(result){
				//返回图书资料列表显示页面
