...
<head>
	...
	<link href="${STYLES_PATH}/login.css" rel="stylesheet"></link>
</head>
<body onload="refresh();">
	<script>
		function refresh() {
		...
		<div class="box">
			<div class="logo_box">
				<div class="logo"><img src="${RESOURCE_PATH}/images/logo.png"/></div>
				<div class="logo_text">综合生产管理系统</div>
			</div>
			<div class="content">
				<div class="content_box">
					<div class="content_img"><img src="${RESOURCE_PATH}/images/img.png"/></div>
					<div class="content_input_box">
						<div class="content_input_list">
							<div class="content_input_img"><img src="${RESOURCE_PATH}/images/admin.png"/></div>
							<input type="text" id="userNo" name="userNo" placeholder="用户名" class="content_input"/>
						</div>
						<div class="content_input_list">
							<div class="content_input_img"><img src="${RESOURCE_PATH}/images/password.png"/></div>
