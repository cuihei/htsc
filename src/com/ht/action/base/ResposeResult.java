...
public class ResposeResult {
	...
	public static String getResposeResult(String resultCode,Object resultValue){
		...
		result.put(ResultConstants.RESULT_CODE_KEY, resultCode);
		if (resultValue!=null) {
			result.put(ResultConstants.RESULT_VALUE_KEY, resultValue);
		}
	...
	public static String getSucessResult(Object resultValue){
		return getResposeResult(ResultConstants.RESULT_CODE_SUCCESS,resultValue);
	}
	...
	public static String getFailResult(String errorMsg){
		return getResposeResult(ResultConstants.RESULT_CODE_FAIL,errorMsg);
	}
}
