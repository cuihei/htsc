...
public class BookInfoAction extends BaseAction {
	...
	public String init() throws Exception{
		...
		// 将获取的节点字符串返回给前台页面
		request.setAttribute("html", ddata.getListNode(baseDataService,datumcategoryService,ids,result,userService));
		return SUCCESS;
	}
	...
	public String batchBorrowingInit() throws Exception{
		...
		BookInfoPage bookInfoPage = new BookInfoPage();
		//将获取的节点字符串返回到前台页面
		request.setAttribute("html", bookInfoPage.getBatchBorrowing(ids,userNo));
		return SUCCESS;
	}
