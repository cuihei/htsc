...
public class FiledDataAction extends BaseAction {
	...
	public String init()  throws Exception{
		...
		request.setAttribute("html", fdPage.getListNode(baseDataService,datumcategoryService,ids,result,userService));
		return SUCCESS;
	}
	...
	public String batchBorrowingInit() throws Exception{
		...
		FiledDataPage filedDataPage = new FiledDataPage();
		//将获取的节点字符串返回到前台页面
		request.setAttribute("html", filedDataPage.getBatchBorrowing(ids,userNo));
		return SUCCESS;
	}
