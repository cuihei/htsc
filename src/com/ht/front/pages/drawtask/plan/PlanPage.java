...
public class PlanPage {
	...
	public String getEditPage(BaseDataService baseDataService,PlanService planService,String id,String type,String categoryId) {
		...
		if (StringUtils.isNotBlank(id)) {
			...
			ig = InputGroup.getInGroup("基测", "measurementPeriod", plan.getMeasurementPeriod()==null?null:plan.getMeasurementPeriod(), "基测");
			param.add(ig);
			ig = InputGroup.getInGroup("检测", "testIng", plan.getTestIng()==null?null:plan.getTestIng(), "检测");
			param.add(ig);
