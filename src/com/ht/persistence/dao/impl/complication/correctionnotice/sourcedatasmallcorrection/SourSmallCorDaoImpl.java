package com.ht.persistence.dao.impl.complication.correctionnotice.sourcedatasmallcorrection;
 ...
 *
 */
public class SourSmallCorDaoImpl extends BaseDaoImpl implements SourSmallCorDao{
	 ...
	 */
	@Override
	public List<CorNotice> findSourSmallCorList() {
		try {
