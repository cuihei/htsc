...
public class FormValue extends BaseModel {
	...
	public String getFormBb() {
		return formBb;
	}

	public void setFormBb(String formBb) {
		this.formBb = formBb;
	}
	...
	public String toString() {
		return "FormValue [id=" + id + ", formId=" + formId + ", propKey=" + propKey + ", processInstId="
				+ processInstId + ", taskInstId=" + taskInstId + ", rowFlag=" + rowFlag + ", formBb=" + formBb
				+ ", creationDate=" + creationDate + ", propValue=" + propValue + ", form=" + form + "]";
	}
