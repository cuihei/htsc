 ...
 */
@Entity
@Table(name = "FILED_DATA")
public class FiledData extends BaseModel {
	...
	@Column(name = "sea_area", length = 32)
	...
	private String total;	// 总份数

	@Column(name = "can_borrowing", length = 32)
	private String canBorrowing;	// 可借份数
