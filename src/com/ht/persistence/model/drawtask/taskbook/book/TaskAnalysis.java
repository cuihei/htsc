...
*/
@Table(name = "V_ACT_HI_TASKINST")
public class TaskAnalysis extends BaseModel
{
	private String id;
	...
	private String delivertime;    //计划汇交
	private String type;    //制图类型
	private String sjhjtime;    //实际汇交
	private String yjtime;    //预警
	...
	public String getSjhjtime() {
		return sjhjtime;
	}
	public void setSjhjtime(String sjhjtime) {
