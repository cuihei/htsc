 ...
 * 2016/12/4
 */
public class EleCover extends BaseExperience
{
	 ...
	 * 数据集文件名
	 */
	final String DATA_NAME = "text_cover_data_name";
	
	/**
	 * 数据集类型
	 */
	final String DATA_TYPE = "text_cover_data_type";
	...
	{
		this.map.put(this.DATA_TYPE, data_type);
	}
	
	public void setDATA_NAME(String data_name)
	{
		this.map.put(this.DATA_NAME, data_name);
	}
