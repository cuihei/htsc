...
public interface TaskBookService
{
	 ...
	 * @throws Exception
	 */
	List<TaskBookEditHis> findEditListById(String taskbookId) throws Exception;
/*
 * 新增修订记录
 */
	String addTaskBookEdit(String taskbookid, String editcount, String creatro,String taskbookNo,String nowtime);
	/**
	 * 获取修订记录条数
	 * @param id
	 * @return
	 * @throws Exception
	 */
	int editCount(String taskbookId) throws Exception;
	 ...
	 * @throws Exception
	 */
	String  findTaskselect(String taskselect) throws Exception;
