...
* @Description: 流程表单service接口
* @author penghao
* @date 2016年10月28日 上午10:57:01 
*  
*/
public interface TaskFormService {
	 ...
	 * @throws DBException 
	 */
	public void assignedUser(String taskId, String processInstId, String processDefId,
			String taskGroupId,String userId, String parentProcessInstId)
			throws DBException;
	
	/**
	 * 分配用戶时更新一次COMPILATION_TASK_PLAN
	 * @param taskId 任务ID
	 * @param processInstId 流程实例ID
	 * @param userId 用户ID
	 * @throws DBException 
	 */
	public void updateTaskProgress(String taskId, String processInstId, String processDefId,String taskGroupId,String userId, String parentProcessInstId,String agreeValue,String taskName)
			throws DBException;
